...
class Vector(object):
    ...
    Attributes:
        ...
        magnitude (float): Vector magnitude.
            Initially null - only calculates if needed, saves computational cost
        hash (int): Hash value for use as dict key.
            Initially null - only calculates if needed, saves computational cost
    """
    ...
    def reset_hash_mag(self):
        """Reset hash and magnitude to None such that they are recalculated later."""
